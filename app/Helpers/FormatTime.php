...
/*Despues de crear este codigo hay que crear el Provider que nos permitirá cargar el helper dentro de Laravel
con el comando "php artisan make:provider FormatTimeServiceProvider" en la consola de comandos.
*/
